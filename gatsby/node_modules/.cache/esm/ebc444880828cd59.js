let path,fetch;_082‍.x([["sourceNodes",()=>sourceNodes],["createPages",()=>createPages]]);_082‍.w("path",[["default",["path"],function(v){path=v}]]);_082‍.w("isomorphic-fetch",[["default",["fetch"],function(v){fetch=v}]]);
...
async function turnToppingsIntoPages({ graphql, actions }) {
    ...
    //loop over data and create page for that topping
       data.toppings.nodes.forEach((topping) => {
        _082‍.g.console.log(`Creating page for topping`, topping.name);
        actions.createPage({

let path,fetch;_a28‍.x([["sourceNodes",()=>sourceNodes],["createPages",()=>createPages]]);_a28‍.w("path",[["default",["path"],function(v){path=v}]]);_a28‍.w("isomorphic-fetch",[["default",["fetch"],function(v){fetch=v}]]);
...
async function turnToppingsIntoPages({ graphql, actions }) {
    ...
    //loop over data and create page for that topping
       data.toppings.nodes.forEach((topping) => {
        _a28‍.g.console.log(`Creating page for topping`, topping.name);
        actions.createPage({
